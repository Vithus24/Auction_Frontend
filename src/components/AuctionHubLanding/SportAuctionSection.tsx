...
const SportAuctionSection: React.FC<SportAuctionSectionProps> = ({ navigateToPage, getThemeClasses }) => (
        ...
        <div className="relative">
          ...
          <div className={`relative ${getThemeClasses('bg-gradient-to-br from-slate-800/90 to-blue-900/90 backdrop-blur-sm border border-blue-500/30', 'bg-gradient-to-br from-gray-200/90 to-blue-200/90 backdrop-blur-sm border border-blue-300/30')} rounded-3xl p-8`}>
            ...
            <h2 className="text-4xl font-bold mb-4">
              <span className={`${getThemeClasses('bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent', 'bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent')}`}>Sports Auctions</span>
            </h2>
